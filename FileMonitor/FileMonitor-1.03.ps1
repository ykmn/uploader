...
v1.03 2020-02-18 added configuration array with uploader.ps1 version
...
$ConfigTable = @(
    ...
    [PSCustomObject]@{
        ...
        Exe = '.\runps3.bat' },
    [PSCustomObject]@{
        Xml = 'ЕВРОПА-Urban.xml'
        Cfg = 'ep-urban-v3.cfg'
        Exe = '.\runps3.bat' },
    [PSCustomObject]@{
        Xml = 'ЕВРОПА-LIGHT.xml'
        Cfg = 'ep-light-v3.cfg'
        Exe = '.\runps3.bat' },
