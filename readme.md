Uploader 2.07beta8
==================
19.09.2017 Roman Ermakov <r.ermakov@emg.fm>
...
* Если в МБД используются пользовательские атрибуты (User Attributes) "Русский исполнитель" и "Русское название", то необходимо заменить соответствующие им ID в строках скрипта:
