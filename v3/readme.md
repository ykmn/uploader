Uploader 2.07.015
==================
24.12.2019 Roman Ermakov <r.ermakov@emg.fm>
...
* Если текущий json-файл не отличается от "последнего удачного", то программа завершает работу.
  * При запуске скрипта с параметром `-force` (например из командной строки `uploader-2.ps1 test.cfg -force`) программа форсированно продолжает работу.
...
Версии:
-------
v1.00 2015-10-09 начальная версия: отправка XML на удалённые FTP.
...
v2.07 2017-07-13 скрипт полностью переписан на Windows Powershell; добавлена отправка A/T в Omnia ProStream; добавлено множество дополнительных проверок и условий (см. readme.md).
...
v2.07.011 2018-03-06 добавлена поддержка передачи RDS в кодер Deva SmartGen по UDP.

v2.07.012 2018-07-12 исправлена ошибка с функцией замены строк по хэш-таблице.

v2.07.013 2018-07-17 добавлена поддержка RDS-кодера Orban 8700i; добавлена возможность замены PS по команде из закладки 'RDS' в карточке Джина.

v2.07.013a 2018-08-01 исправлен синтаксис, добавлены новые значения RDS в файл конфигурации, дополнена документация.

v2.07.013b 2018-08-30 исправлена ошибка с обновлением RDS PS.

v2.07.014 2018-09-03 исправлена еще одна ошибка с обновлением RDS PS.

v2.07.015 2019-04-18 добавлена выгрузка на FTP если играет не только песня, но и реклама; добавлен параметр командной строки -force; добавлена проверка наличия .cfg и .xml

v2.07.015 2019-12-24 добавлен FileMonitor.ps1 - программа следит на изменением .xml-файлов в папке $PathToMonitor и при изменении .xml запускает runps.bat с параметром (именем файла конфигурации .cfg, соответствия XML и cfg описаны в словаре $ConfigTable)
